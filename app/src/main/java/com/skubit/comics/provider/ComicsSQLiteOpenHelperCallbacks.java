 ...
 */
public class ComicsSQLiteOpenHelperCallbacks {
    private static final String TAG = ComicsSQLiteOpenHelperCallbacks.class.getSimpleName();
    ...
    public void onUpgrade(final Context context, final SQLiteDatabase db, final int oldVersion, final int newVersion) {
      ...
      //  new ComicsSQLiteUpgradeHelper().onUpgrade(db, oldVersion, newVersion);
    }
}
