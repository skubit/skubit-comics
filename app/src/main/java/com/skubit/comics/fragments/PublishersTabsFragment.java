...
public class PublishersTabsFragment extends Fragment {
    ...
    public View onCreateView(
        ...
        View v = inflater.inflate(R.layout.fragment_publishers_tabs, container, false);
        mPagerSlidingTabStrip = (PagerSlidingTabStrip) v.findViewById(R.id.tabs);
        pager = (ViewPager) v.findViewById(R.id.publishers_pager);
    ...
    public class MyPagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            return PublisherFragment.newInstance(filter);
        }
    }
}
