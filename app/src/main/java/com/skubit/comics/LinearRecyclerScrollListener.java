...
public abstract class LinearRecyclerScrollListener extends RecyclerView.OnScrollListener {

    public static String TAG = LinearRecyclerScrollListener.class.getSimpleName();
